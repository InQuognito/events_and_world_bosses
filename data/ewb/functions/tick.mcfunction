...
execute at @e[type=item,nbt={Item:{id:"minecraft:glass_bottle"}}] if entity @e[type=experience_orb,distance=..1.6] run tag @s add to_xpb
#execute as @e[type=item,nbt={Item:{id:"minecraft:glass_bottle"}}] if entity @e[type=experience_orb,distance=..1.6] run say hi
execute at @e[type=item,tag=to_xpb] run say hi2
execute at @e[type=item,tag=to_xpb] run kill @e[type=experience_orb,distance=..1.6]
execute at @e[type=item,tag=to_xpb] run summon item ~ ~ ~ {Item:{id:"minecraft:experience_bottle"}}
execute at @e[type=item,tag=to_xpb] run tp @s ~ -6164 ~