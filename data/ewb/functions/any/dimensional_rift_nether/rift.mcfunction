...
execute as @e[type=minecraft:area_effect_cloud,tag=riftNether.rift,tag=!riftNether.unprocessed,predicate=ewb:chance_80] at @s run function ewb:any/dimensional_rift_nether/mobs
schedule function ewb:any/dimensional_rift_nether/rift 600t replace
