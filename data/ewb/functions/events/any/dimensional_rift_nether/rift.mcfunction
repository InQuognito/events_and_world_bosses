...
execute as @e[tag=riftNether.unprocessed] at @s run function ewb:rng/rift_teleport

execute as @e[tag=riftNether.rift,tag=!riftNether.unprocessed,predicate=ewb:chance_80] at @s run function ewb:events/any/dimensional_rift_nether/mobs
