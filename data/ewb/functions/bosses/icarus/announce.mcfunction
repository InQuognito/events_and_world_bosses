execute store result score #x event run data get entity @e[type=phantom,tag=icarus.Boss,limit=1] Pos[0]
execute store result score #y event run data get entity @e[type=phantom,tag=icarus.Boss,limit=1] Pos[1]
execute store result score #z event run data get entity @e[type=phantom,tag=icarus.Boss,limit=1] Pos[2]
