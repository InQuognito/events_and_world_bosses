...
execute unless block ~ ~-1 ~ #ewb:invalid_spawn_block if block ~ ~ ~ #ewb:no_hitbox if block ~ ~1 ~ #ewb:no_hitbox if block ~ ~2 ~ #ewb:no_hitbox run function ewb:events/any/dimensional_rift/nether/rift/activate
