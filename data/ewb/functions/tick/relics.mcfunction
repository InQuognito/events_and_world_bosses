# Ancient Tome
execute as @a[scores={useRelic=1..},nbt={SelectedItem:{tag:{Relic:[ancient_tome]}}}] if predicate ewb:equipment.offhand.enchanted if predicate ewb:equipment.offhand.has_max_enchantment if predicate ewb:xp_level_30 run function ewb:relics/ancient_tome/check
...
# Reset Score
scoreboard players reset @a[scores={useRelic=1..}] useRelic
